...
// Ficheiro     : World.js
// Descrição    : E FOLIO A - Computação Gráfica - ficheiro que reune todas as
...
class World {
  constructor(container) {
    /* Para reinicializar todas as partes do objetos criados 
    anteriormente dentro do ficheiro World */
